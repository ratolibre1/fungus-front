...
const ClientSearchSelector = ({ clients, suppliers, value, onChange, onClientCreated, disabled, error }) => {
    ...
    const handleAddClientRole = async (supplier) => {
        setAddingRole(true);
        try {
...
export default function QuotationFormModal({ quotation, isOpen, onClose, onSubmit, loading = false }) {
    ...
    const populateFormData = (quotation) => {
