...
// Definimos las props que puede recibir el componente
interface IconBackgroundProps {
  // Ruta a la imagen SVG (opcional)
  svgPath?: string;
  // Color base para los iconos (opcional)
  baseColor?: string;
}
 ...
 */
const generateColorFilter = (baseColor: string, index: number, type: 'light' | 'dark' | 'base'): string => {
...
const IconBackground: React.FC<IconBackgroundProps> = ({
  ...
  for (let i = 0; i < 900; i++) {
    ...
    let colorVariation: 'light' | 'dark' | 'base' = 'base';
    ...
    points.push(
      <div className={'diamond-point'} key={i}>
        <img
          src={iconSrc}
          alt="Icon"
          style={{
