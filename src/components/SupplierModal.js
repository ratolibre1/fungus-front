...
export default function SupplierModal({ isOpen, modalType, selectedSupplier, loading, onClose, onSubmit }) {
    ...
    // Inicializar el formulario cuando cambia el proveedor seleccionado o el tipo de modal
    useEffect(() => {
        setValidationErrors({
            rut: null,
            email: null,
        ...
        else if ((modalType === 'edit' || modalType === 'view') && selectedSupplier) {
            setFormData({
    ...
    return (_jsxs(PortalModal, { isOpen: isOpen, onClose: onClose, children: [_jsx("div", { className: "modal-backdrop fade show", style: { zIndex: 1050 }, onClick: onClose }), _jsx("div", { className: "modal fade show", style: {
                    display: 'block',
                    zIndex: 1055
                }, tabIndex: -1, children: _jsx("div", { className: "modal-dialog", children: _jsxs("div", { className: "modal-content", children: [_jsxs("div", { className: "modal-header", children: [_jsxs("h5", { className: "modal-title", children: [modalType === 'create' && 'Nuevo Proveedor', modalType === 'edit' && 'Editar Proveedor', modalType === 'delete' && '¿Eliminar Proveedor?', modalType === 'view' && 'Detalles del Proveedor'] }), _jsx("button", { type: "button", className: "btn-close", onClick: onClose })] }), _jsx("div", { className: "modal-body", children: modalType === 'create' || modalType === 'edit' ? (_jsxs("form", { onSubmit: handleSubmit, children: [_jsxs("div", { className: "mb-3", children: [_jsxs("label", { className: "form-label", children: ["Nombre ", _jsx("span", { style: { color: '#dc3545' }, children: "*" })] }), _jsx("input", { type: "text", className: "form-control", name: "name", value: formData.name, onChange: handleTextChange, required: true, placeholder: "Ej: Productos Naturales SPA" })] }), _jsxs("div", { className: "mb-3", children: [_jsxs("label", { className: "form-label", children: ["RUT ", _jsx("span", { style: { color: '#dc3545' }, children: "*" })] }), _jsx("input", { type: "text", className: "form-control", name: "rut", value: formData.rut, onChange: handleRutChange, onKeyDown: handleRutKeyDown, required: true, placeholder: "Ej: 12.345.678-9" }), validationErrors.rut && (_jsx("small", { className: "text-danger", children: validationErrors.rut })), _jsx("small", { className: "form-text text-muted d-block", children: "Formato: 12.345.678-9" })] }), _jsxs("div", { className: "mb-3", children: [_jsxs("label", { className: "form-label", children: ["Email ", _jsx("span", { style: { color: '#dc3545' }, children: "*" })] }), _jsx("input", { type: "email", className: "form-control", name: "email", value: formData.email, onChange: handleTextChange, required: true, placeholder: "Ej: contacto@proveedor.com" }), validationErrors.email && (_jsx("small", { className: "text-danger", children: validationErrors.email }))] }), _jsxs("div", { className: "mb-3", children: [_jsxs("label", { className: "form-label", children: ["Tel\u00E9fono ", _jsx("span", { style: { color: '#dc3545' }, children: "*" })] }), _jsx("input", { type: "text", className: "form-control", name: "phone", value: formData.phone, onChange: handlePhoneChange, onKeyDown: handlePhoneKeyDown, required: true, placeholder: "Ej: 9 1234 5678" }), validationErrors.phone && (_jsx("small", { className: "text-danger", children: validationErrors.phone })), _jsx("small", { className: "form-text text-muted d-block", children: "Formato: 9 1234 5678" })] }), _jsxs("div", { className: "mb-3", children: [_jsxs("label", { className: "form-label", children: ["Direcci\u00F3n ", _jsx("span", { style: { color: '#dc3545' }, children: "*" })] }), _jsx("input", { type: "text", className: "form-control", name: "address", value: formData.address || '', onChange: handleTextChange, required: true, placeholder: "Ej: Av. La Dehesa 123, Santiago" })] })] })) : modalType === 'delete' ? (_jsxs("p", { children: ["\u00BFEst\u00E1s seguro de que deseas eliminar a ", _jsx("strong", { children: selectedSupplier?.name }), "?"] })) : (_jsxs("div", { children: [_jsxs("p", { children: [_jsx("strong", { children: "Nombre:" }), " ", selectedSupplier?.name] }), _jsxs("p", { children: [_jsx("strong", { children: "RUT:" }), " ", formatRut(selectedSupplier?.rut || '')] }), _jsxs("p", { children: [_jsx("strong", { children: "Email:" }), " ", selectedSupplier?.email] }), _jsxs("p", { children: [_jsx("strong", { children: "Tel\u00E9fono:" }), " ", selectedSupplier?.phone ? formatPhone(selectedSupplier.phone) : 'No especificado'] }), _jsxs("p", { children: [_jsx("strong", { children: "Direcci\u00F3n:" }), " ", selectedSupplier?.address || 'No especificada'] }), _jsxs("p", { children: [_jsx("strong", { children: "Creado:" }), " ", selectedSupplier && new Date(selectedSupplier.createdAt).toLocaleDateString()] }), _jsxs("p", { children: [_jsx("strong", { children: "Actualizado:" }), " ", selectedSupplier && new Date(selectedSupplier.updatedAt).toLocaleDateString()] })] })) }), _jsxs("div", { className: "modal-footer", children: [_jsx("button", { type: "button", className: "btn btn-secondary", onClick: onClose, children: modalType === 'view' ? 'Cerrar' : 'Cancelar' }), modalType !== 'view' && (_jsx("button", { type: "button", className: `btn ${modalType === 'delete' ? 'btn-danger' : ''}`, style: modalType !== 'delete' ? { backgroundColor: '#099347', color: 'white' } : {}, onClick: handleSubmit, disabled: loading || ((modalType === 'create' || modalType === 'edit') && !isFormValid), children: loading ? (_jsxs(_Fragment, { children: [_jsx("span", { className: "spinner-border spinner-border-sm me-2", role: "status", "aria-hidden": "true" }), "Procesando..."] })) : (modalType === 'create' ? 'Crear' :
