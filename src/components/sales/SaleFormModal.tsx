...
interface SaleFormModalProps {
  ...
  isOpen: boolean;
  onClose: () => void;
  onSubmit: (formData: SaleSubmitData) => void;
  loading?: boolean;
}
...
const ClientSearchSelector: React.FC<ClientSearchProps> = ({
  ...
  const handleAddCustomerRole = async (supplier: Supplier) => {
    setAddingRole(true);
    try {
                      ...
                      <div key={`supplier-${supplier._id}`} className="list-group-item bg-light">
                        <div className="d-flex justify-content-between align-items-center">
                          ...
                          <button
                            ...
                            onClick={() => handleAddCustomerRole(supplier)}
                            disabled={addingRole}
                          >
                            {addingRole ? (
...
export default function SaleFormModal({
  ...
  const populateFormData = (sale: Sale) => {
  ...
  // Actualizar item
  const updateItem = (index: number, field: keyof SaleItemForm, value: string | number, productData?: Product) => {
    setFormData(prev => {
                  ...
                  <>
                    ...
                    <div className="mb-4">
                      <div className="d-flex justify-content-between align-items-center mb-3">
                        <h6 className="mb-0">Items de la Venta</h6>
                        <button
                          type="button"
